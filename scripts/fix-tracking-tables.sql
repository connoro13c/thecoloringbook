...
-- 4. Create page_generations table
...
SELECT 
    table_name,
    CASE 
        WHEN table_name IN ('upload_sessions', 'image_uploads', 'image_analyses', 'page_generations') 
        THEN '✓ Required tracking table'
        ELSE 'Other table'
    END as status
